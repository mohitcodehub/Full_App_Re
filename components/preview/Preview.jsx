...
const Preview = () => {
  ...
  return (
    <div className="md:max-w-[60%] sticky top-0 preview rm-padding-print p-4 md:overflow-y-scroll md:h-screen bg-white backdrop-blur-sm rounded-2xl border border-white/10 m-4">
      <A4PageWrapper>
        <HighlightMenu
          styles={{
            borderColor: "#C026D3",
