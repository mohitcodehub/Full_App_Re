    ...
    <>
      ...
      >
        ...
        <div className="f-col gap-4 md:flex-row justify-evenly max-w-7xl md:mx-auto md:h-screen">
          {!formClose && (
            <form className="p-6 bg-gradient-to-br from-slate-800/90 to-slate-900/90 backdrop-blur-xl exclude-print md:max-w-[40%] md:h-screen md:overflow-y-scroll border border-slate-700/50 shadow-2xl rounded-2xl m-4">
              <div className="space-y-6">
              <LoadUnload/>
              <div className="bg-gradient-to-r from-slate-700/50 to-slate-800/50 p-4 rounded-xl border border-slate-600/30 shadow-lg">
              <PersonalInformation />
              </div>
              <div className="bg-gradient-to-r from-slate-700/50 to-slate-800/50 p-4 rounded-xl border border-slate-600/30 shadow-lg">
              <SocialMedia />
              ...
              </div>
              {
                resumeData.skills.map((skill, index) => (
                  <div key={index} className="bg-gradient-to-r from-slate-700/50 to-slate-800/50 p-4 rounded-xl border border-slate-600/30 shadow-lg">
                  <Skill
                    title={skill.title}
                  />
                  </div>
